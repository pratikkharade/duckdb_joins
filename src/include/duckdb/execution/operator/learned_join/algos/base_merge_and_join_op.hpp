...
namespace learned_index {
    ...
    //     public:
    //         BaseMergeAndJoinOp(SSTable<T> *outer, SSTable<T> *inner, IndexBuilder<T> *inner_index_builder, Comparator<T> *comparator, PSSTableBuilder<T> *result_builder, int num_threads):
    //             TableOp<T>(outer, inner, result_builder, num_threads), comparator_(comparator), inner_index_builder_(inner_index_builder) {}
